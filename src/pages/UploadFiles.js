...
import UploadAdminDetails from "../components/UploadAdminDetails/UploadAdminDetails";
import UploadProductImages from "../components/UploadProductImages/UploadProductImages";
import UploadStaffDetails from "../components/UploadStaffDetails/UploadStaffDetails";
  ...
  return (
    <div>
      <Helmet>
        ...
        <title>Upload files | Stylekunj Controls</title>
...
export default ProtectedRoute(UploadFiles);
