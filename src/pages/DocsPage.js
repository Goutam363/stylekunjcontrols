...
import AddressDocs from "../components/Docs/AddressDocs";
import RefreshButtonDocs from "../components/Docs/RefreshButtonDocs";
  ...
  return (
    <div>
      <Helmet>
        ...
        <title>Docs | Stylekunj Controls</title>
      ...
      <AppBarComponent />
      <h1 style={{ marginLeft: "1rem" }}>Stylekunj Docs</h1>
      <RefreshButtonDocs />
      <AddressDocs />
    </div>
  );
...
export default ProtectedRoute(DocsPage);
